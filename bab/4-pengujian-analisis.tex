...
% === E's Comment ===
% It's a good idea to \ref{} stuff previous and current chapters, I got a positive note for that
% Maybe try converting your \tabular and \table into \longtable?
% And \textbf{} the best result in every table so it's easier to read
% Also maybe round the numbers a bit so they're not too long? to three or four decimal points
% Apologies for spamming \pagebreak
...
Dari seluruh arsitektur \emph{ResNet} yang digunakan, nilai QWK tertinggi sebesar \textbf{0.7583626695732866} didapatkan dari arsitektur \emph{ResNet-18}.
...
Dari seluruh arsitektur \emph{ResNet} yang digunakan, nilai QWK tertinggi sebesar \textbf{0.7332556875533816} didapatkan dari arsitektur \emph{ResNet-18}.
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-18]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet18.png} }}%
	\label{fig:confRes18}
\end{figure}
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-34]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet34.png} }}%
	\label{fig:confRes34}
\end{figure}
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-50]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet50.png} }}%
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-101]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet101.png} }}%
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-152]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet152.png} }}%
...
\begin{table}[hbtp]
	\begin{center}
		...
		\begin{tabular}{|c|l|c|l|l|l|c|}
			...
			& NPDR                                               &                          & 0,704545                                          & \textbf{0,72093}                                 & 0,712644                                        &                                      \\ \cline{2-2} \cline{4-6}
			\multirow{-3}{*}{18}  & PDR                                                & \multirow{-3}{*}{0,7886} & \textbf{0,666667}                                 & 0,714286                                         & 0,689655                                        & \multirow{-3}{*}{\textbf{0.7526956474324895}} \\ \hline
...
\begin{itemize}
	...
	\item Untuk dataset non-DR didapatkan nilai precision sebesar \textbf{0,916667} dari arsitektur \emph{ResNet-18}, recall \textbf{0,848485} yang didapatkan pada arsitektur \emph{Resnet-18} dan \emph{ResNet-50}, dan F1 sebesar \textbf{0,873016} dari arsitektur \emph{ResNet-101};
...
Dari seluruh arsitektur \emph{ResNet} yang digunakan, nilai QWK tertinggi sebesar \textbf{0.7526956474324895} didapatkan dari arsitektur \emph{ResNet-18}.
...
Dari seluruh arsitektur \emph{ResNet} yang digunakan, nilai QWK tertinggi sebesar \textbf{0.7084479219119185} didapatkan dari arsitektur \emph{ResNet-50}.
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-18]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet18class-weighted.png} }}%
...
\begin{figure}
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-34]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet34class-weighted.png} }}
...
\begin{figure}[hbtp]
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-50]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet50class-weighted.png} }}
...
\begin{figure}
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-101]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet101class-weighted.png} }}
...
\begin{figure}
	...
	\qquad
	\subfloat[\centering Last Trained ResNet-152]{{\includegraphics[width=6.5cm]{gambar/last model/confusionMatrixResnet152class-weighted.png} }}
