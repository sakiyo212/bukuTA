...
\begin{figure}[hbtp]
	\centering
	\subfloat{{\includegraphics[width=4cm]{gambar/0_0.png} }}%
	\subfloat{{\includegraphics[width=4cm]{gambar/0_1.png} }}%
	\subfloat{{\includegraphics[width=4cm]{gambar/0_2.png} }}
...
\begin{figure}[hbtp]
	\centering
	\subfloat{{\includegraphics[width=4cm]{gambar/1_0.png} }}%
	\subfloat{{\includegraphics[width=4cm]{gambar/1_1.png} }}%
	\subfloat{{\includegraphics[width=4cm]{gambar/1_2.png} }}
	\caption{Hasil \emph{\emph{heatmap}} dari dataset class 1}
	\label{fig:GRAD1}
\end{figure}

\begin{figure}[hbtp]
	\centering
	\subfloat{{\includegraphics[width=4cm]{gambar/2_0.png} }}%
	\subfloat{{\includegraphics[width=4cm]{gambar/2_1.png} }}%
	\subfloat{{\includegraphics[width=4cm]{gambar/2_2.png} }}
	\caption{Hasil \emph{\emph{heatmap}} dari dataset class 2}
	\label{fig:GRAD2}
\end{figure}
