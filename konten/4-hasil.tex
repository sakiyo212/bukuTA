...
\begin{figure}[hbtp]
    \centering
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet18class-weighted_bestTrain.png} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet18class-weighted_bestVal.png} }}%
    \qquad
    \subfloat[\centering label 1]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet34class-weighted_bestTrain.png} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet34class-weighted_bestVal.png} }}%
...
\begin{figure}[hbtp]
    \centering
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet50class-weighted_bestTrain.png} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet50class-weighted_bestVal.png} }}%
    \qquad
    \subfloat[\centering label 1]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet101class-weighted_bestTrain.png} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=6.5cm]{gambar/confusionMatrixResnet101class-weighted_bestVal.png} }}%
    \caption{2 Figures side by side}%
    \label{fig:example}
\end{figure}
